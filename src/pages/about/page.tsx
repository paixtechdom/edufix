...
const AboutPage = () => {
  return (
    <>
      <Helmet>
          <title>About | EDUCFIX</title>
          <meta name="description" content="Our Mission
          To advance knowledge through research and building of future leaders.
          Our Goal
          Our goal is to build, train and certify 10M+ leaders in different areas of life" />
      </Helmet>
