...
const BecomePage = () => {
  ...
  return (
    <>
       <Helmet>
         <title>Become a Createhive | EDUCFIX</title>
          <meta name="description" content="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti expedita vel, enim quos laborum id molestiae obcaecati similique nostrum ullam neque nemo sed magnam porro laboriosam sunt voluptate provident! Aut!" />
      </Helmet>
